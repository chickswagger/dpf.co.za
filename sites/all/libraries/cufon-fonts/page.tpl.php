 ...
 */
?>
<div id="content-full-width" class="content-full-width">

 <div id="header-top" class="header-full-width">
<!-- -->
			<div id="header-top" class="header-top-half-width">
			 <?php if ($page['header']): ?>
...
<div id="logo-container" class="logo-half">
		<div id="logo" class="sixteen columns" >
		 ...
		 <div id="header-top-menu" class="header-top-full-width">
		 
            <!-- first menu-->
			<div id="header-top" class="header-top-half-width">
			 <?php if ($page['header_top_menu']): ?>
			   <div id="header" class="sixteen columns">
				...
				<?php if ($page['header_topmenu']): ?>
				<?php print render($page['header_topmenu']); ?>
			    <?php endif; ?>
			    </div>
       </div>
		
					<div id="menu" class="menu-full-width">
					...
					<div id="header-bottom first" class="header-bottom-full-width">
...
<div class="container">   
  ...
  <header id="head" role="banner">
   ...
   <div class="clear"></div>
    ...
    <div class="eleven columns omega" id="headright">
     ...
     <!-- <ul>
      <li class="first"> <a title="Login for existing users and Fitment operators" href="http://recoveri.net/drupal/">Database Login</a> </li>
      <li class="last"><a title="First time asset registration, Excluding assets with VIN numbers." href="http://recoveri.net/drupal/">Register an Asset</a> </li></ul>-->
      </div>
      <div id="socialbar">
        <ul class="social">
 ...
 <div id="outter content" class="full-outter-content-width"> 
  ...
  <?php if ($is_front): ?>
    ...
    <?php if (theme_get_setting('slideshow_display', 'responsive')): ?>
     ...
     <div class="flexslider">
      <ul class="slides">
        <li>
          <a href="<?php print url($url1); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'responsive') . '/images/banner1.png'; ?>"/></a>
          <?php if ($cap1): ?> <div class="flex-caption"> <h3> <?php print $cap1; ?> </h3> </div>  <?php endif; ?>
        </li>
        <li>
          <a href="<?php print url($url2); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'responsive') . '/images/benner2.png'; ?>"/></a>
          <?php if ($cap2): ?> <div class="flex-caption"> <h3> <?php print $cap2; ?> </h3> </div> <?php endif; ?>
        </li>
        <li>
          <a href="<?php print url($url3); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'responsive') . '/images/benner3.p'; ?>"/></a>
